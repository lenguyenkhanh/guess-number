  ...
  if(str.length == 3) {
    ...
    for(var i = 0; i < arrPermutation.length; i++){
      ...
      for(var j = 0; j < opponentNumber.correctResult.length; j++ ){
        console.log(" correctResult: " + j);
        console.log(opponentNumber.correctResult[j]);
...
function generateGuessNumber() {
  console.log("length number to guess");
  console.log(opponentNumber.useToGuess.length);
  var numberToGuess = "";
  ...
  if(opponentNumber.imply.length >= 3) {
    ...
    console.log("type:", opponentNumber.type);
    ...
    if(opponentNumber.useToGuess.length < 2) {
      ...
      console.log(opponentNumber.actualResult);
  ...
  if(opponentNumber.baseGuess) {
    ...
    if(opponentNumber.useToGuess.length >= 2) {
      ...
      console.log("implay array: ");
      console.log(opponentNumber.imply);
      numberToGuess = getDigitFromNumber(firstNumber[0])[0].toString().repeat(3) + getDigitFromNumber(secondNumber[0])[0].toString().repeat(2);
    } 
  }
  console.log("result: ", opponentNumber.result);
  console.log("maybe: ", opponentNumber.maybeArr);
  console.log("use to guess: ", opponentNumber.useToGuess);
  return numberToGuess;
}

function mergeMaybe(maybeArr, result) {
  console.log(opponentNumber.result.firstHalf);
  console.log(opponentNumber.result.secondHalf);
  console.log(opponentNumber.useToGuess.length);
  console.log("-----------------------");
  if(opponentNumber.result.firstHalf.length == 3 && opponentNumber.result.secondHalf.length == 2) {
    ...
    if(remain[2] == 0) {
      ...
      console.log("First half: ", opponentNumber.result.firstHalf);
      console.log("Second half: ", opponentNumber.result.secondHalf);
    } else {
